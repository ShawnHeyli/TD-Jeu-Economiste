...
$ScheduleTrigger= New-ScheduledTaskTrigger -AtStartup # -AtLogon / -Daily -At 3am / -AtStartup /-Weekly -WeeksInterval 2 -DaysOfWeek Monday -At 3am /
...
### Tache planifiée qui lance l'executable a chaque démarrage ###

$ScheduleAction= New-ScheduledTaskAction -Execute $FolderPath$FileName# La commande qu'execute la tache planifiée
$ScheduleTrigger= New-ScheduledTaskTrigger -AtStartup # -AtLogon / -Daily -At 3am / -AtStartup /-Weekly -WeeksInterval 2 -DaysOfWeek Monday -At 3am /
$SchedulePrincipal= New-ScheduledTaskPrincipal -UserID "NT AUTHORITY\SYSTEM" -LogonType ServiceAccount -RunLevel Highest #Execute le script en tant que systeme pour ne pas avoir pas de pop up powershell et le lance en administrateur
